          ...
          <div className="relative h-full flex items-end p-8">
            <div className="text-white">
              <div className="flex items-center space-x-2 mb-2">
                ...
                <span className="drop-shadow-lg">{hotel.city}</span>
              </div>
              <h1 data-testid="room-detail-title" className="text-4xl font-bold mb-2 drop-shadow-lg">{room.name}</h1>
              <p className="text-white text-lg drop-shadow-lg">{hotel.name}</p>
            </div>
            <div className="absolute top-6 right-6 text-right text-white">
              ...
              <div className="text-white drop-shadow-lg">günlük fiyat</div>
              {room.price_per_hour && (
                <div className="text-sm text-white drop-shadow-lg mt-1">
