                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-2 border-indigo-200 rounded-lg p-4 bg-indigo-50">
                      <div className="flex items-start space-x-3">
                        ...
                        />
                        <label htmlFor="terms" className="flex-1 text-sm text-gray-700">
                          <span className="font-medium text-gray-900">
                            Kiralama Sözleşmesi'ni okudum ve kabul ediyorum.
                          </span>
                          {' '}
                          <button
                            type="button"
                      ...
                      {!termsAccepted && (
                        <p className="mt-2 text-xs text-amber-700 ml-8">
                          ⚠️ Rezervasyonu tamamlamak için sözleşmeyi kabul etmelisiniz
                        </p>
                      )}
                    </div>
